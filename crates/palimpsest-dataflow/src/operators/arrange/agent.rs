...
use timely::dataflow::operators::generic::{source, OperatorInfo};
...
use crate::trace::{BatchReader, Trace, TraceReader};
...
impl<Tr: TraceReader> TraceAgent<Tr> {
        ...
        Tr: Trace,
    {
        ...
        if let Some(logging) = &logging {
            logging.log(crate::logging::TraceShare {
...
impl<Tr: TraceReader + 'static> TraceAgent<Tr> {
    ...
    /// use palimpsest_dataflow::operators::arrange::ArrangeBySelf;
